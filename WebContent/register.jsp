...
<tr ><td class="youduiqi">密码:</td><td><input type="password" id="upassword" class="userinfo" name="e_extend3" onclick="huodejiaodian('upassword')"  onblur="passweikong('upassword')" onkeypress="jiaoyanmima('upassword')"/>
...
<tr><td></td><td><div id="tijiao" onclick="jiaoyansuoyou()"><a href="#" style="background:#f17819; text-decoration:none; text-align:center; color:#FFFFFF; line-height:40px; font-size:20px; display:block; width:240px; height:40px;">创建用户</a></div></td></tr>
</table>
</font>
