<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div id="dingbu">
<p>企业ERP系统、存储产品、服务器购买热线:18312884980</p>
</div>
<div id="tou">
...
<div id="newsbody" style="height:2px;"></div>
...
$("#logo,#dingbu,a.up,#chanpintupian,#bigbody,#denglujiemian,#newsbody").mouseenter(function(){
$("#caidan").slideUp(400);
})
